...
namespace Proxies\__CG__\BankBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Account extends \BankBundle\Entity\Account implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BankBundle\\Entity\\Account' . "\0" . 'id', '' . "\0" . 'BankBundle\\Entity\\Account' . "\0" . 'account', '' . "\0" . 'BankBundle\\Entity\\Account' . "\0" . 'name', '' . "\0" . 'BankBundle\\Entity\\Account' . "\0" . 'phone', '' . "\0" . 'BankBundle\\Entity\\Account' . "\0" . 'balance', '' . "\0" . 'BankBundle\\Entity\\Account' . "\0" . 'entry');
        }
    ...
    public function addEntry(\BankBundle\Entity\Entry $entry)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addEntry', array($entry));
    ...
    public function removeEntry(\BankBundle\Entity\Entry $entry)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeEntry', array($entry));
